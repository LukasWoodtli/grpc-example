...
public class GreetServiceImpl extends GreetServiceGrpc.GreetServiceImplBase {
    ...
    @Override
    public void greetWithError(GreetWithErrorRequest request, StreamObserver<GreetWithErrorResponse> responseObserver) {
        String firstName = request.getGreeting().getFirstName();
        ...
        /* See also:
           ...
           For a richer Error Model:
           https://cloud.google.com/apis/design/errors#error_model
           and
           https://github.com/googleapis/googleapis/blob/master/google/rpc/error_details.proto
         */
        if (!firstName.isEmpty()) {
            responseObserver.onNext(GreetWithErrorResponse.newBuilder().setResult("Hello " + firstName).build());
        } else {
            responseObserver.onError(Status.INVALID_ARGUMENT
                    .withDescription("Empty name sent")
                    .augmentDescription("Empty name is not allowed")
                    .asRuntimeException());
        }
    }
    ...
    public void greetWithDeadline(GreetWithDeadlineRequest request, StreamObserver<GreetWithDeadlineResponse> responseObserver) {
        // see also: https://grpc.io/blog/deadlines/#setting-a-deadline
